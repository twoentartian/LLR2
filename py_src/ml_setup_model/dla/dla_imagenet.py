"""DLA (Deep Layer Aggregation) architecture for ImageNet.

Ported from DFL_torch/py_src/ml_setup_base/dla_imagenet.py.
...
def dla46_c(**kwargs):  # DLA-46-C
    ...
    model = DLA([1, 1, 1, 2, 2, 1],
                [16, 32, 64, 64, 128, 256],
                block=Bottleneck, **kwargs) # type: ignore
    return model
...
def dla46x_c(**kwargs):  # DLA-X-46-C
    ...
    model = DLA([1, 1, 1, 2, 2, 1],
                [16, 32, 64, 64, 128, 256],
                block=BottleneckX, **kwargs) # type: ignore
    return model
...
def dla102(**kwargs):  # DLA-102
    Bottleneck.expansion = 2
    model = DLA([1, 1, 1, 3, 4, 1],
                [16, 32, 128, 256, 512, 1024],
                block=Bottleneck, residual_root=True, **kwargs) # type: ignore
    return model
...
def dla102x(**kwargs):  # DLA-X-102
    ...
    model = DLA([1, 1, 1, 3, 4, 1],
                [16, 32, 128, 256, 512, 1024],
                block=BottleneckX, residual_root=True, **kwargs) # type: ignore
    return model
