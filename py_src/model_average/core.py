...
class ModelAverager:
    ...
    def get_communication_payload(self, model_stat: dict) -> dict:
        """Return the state sent to peers.

        Ordinary averagers communicate only model state. Stateful algorithms
        such as DSGT can override this hook to include auxiliary state.
        """
    ...
    def on_after_averaging(
        ...
        """Update optimizer state after an averaged model is installed."""
